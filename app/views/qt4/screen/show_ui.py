...
class Ui_ScreenShow(object):
    def setupUi(self, ScreenShow):
        ...
        self.menuEdit.addAction(self.actionRemove_node)
        self.menuEdit.addSeparator()
    ...
    def retranslateUi(self, ScreenShow):
        ...
        self.actionAdd_node.setText(QtGui.QApplication.translate("ScreenShow", "Add node", None, QtGui.QApplication.UnicodeUTF8))
        self.actionAdd_node.setShortcut(QtGui.QApplication.translate("ScreenShow", "V", None, QtGui.QApplication.UnicodeUTF8))
        self.actionRemove_node.setText(QtGui.QApplication.translate("ScreenShow", "Remove node", None, QtGui.QApplication.UnicodeUTF8))
        self.actionRemove_node.setShortcut(QtGui.QApplication.translate("ScreenShow", "Shift+V", None, QtGui.QApplication.UnicodeUTF8))
